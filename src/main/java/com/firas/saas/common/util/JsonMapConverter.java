package com.firas.saas.common.util;
 ...
 * This is used instead of @JdbcTypeCode(SqlTypes.JSON) for MariaDB compatibility.
 * MariaDB doesn't support the CAST(? as json) syntax that Hibernate 6 generates.
 */
@Converter
@Slf4j
