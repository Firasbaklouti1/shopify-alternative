...
export default function CollectionList({ section, storeSlug, collections: providedCollections }: SectionProps) {
  const settings = section.settings as CollectionListSettings;
  ...
  useEffect(() => {
    ...
    async function loadCollections() {
      try {
        const data = await getCollections(storeSlug);
        setCollections(data);
      } catch (error) {
